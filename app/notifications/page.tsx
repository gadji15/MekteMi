      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        {loading ? (
          <div className="space-y-6">
            {[...Array(3)].map((_, i) => (
              <Card key={i} className="border-0 bg-gradient-to-br from-card to-muted/30">
              ...
              >
                ...
                <CardContent>
                  ...
                  <div className="flex items-center gap-3 text-sm text-muted-foreground bg-muted/30 px-4 py-2 rounded-lg">
                    ...
                    <span className="font-medium">{formatDate(notification.createdAt ?? notification.created_at)}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
